...
//	@OneToMany	commented this when trying to add a new recipe w/ existing equip... got SQL Error: 1062, SQLState: 23000
	...
	@ManyToMany
	private Set<RecipeName> pairings = new HashSet<>();	// !!!maybe this is drink pairings??... could be any recipe this has ever been made in same meal with??	// rename to drinkPairings
